...
interface DigitalLotteryFooterProps {
...
const DigitalLotteryFooter: React.FC<DigitalLotteryFooterProps> = ({
  summary,
  betCount,
  betAmount,
      ...
      <View className="flex-row items-center justify-between bg-white border-t border-ccc p-3">
        <View className="flex-row gap-2">
          <TouchableOpacity className="center" onPress={onClear}>
            <Image className="w-8 h-8" source={deleteImg} />
          </TouchableOpacity>
          <View>
...
export default DigitalLotteryFooter;
