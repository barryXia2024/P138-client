...
const QRCodeSharePage = () => {
  ...
  return (
    <ViewShot
      ...
      <ImageBackground
        source={require('src/assets/imgs/gendan/followTicket-share.webp')}
        className=" items-center resize-cover "
        ...
        <Image
          ...
          style={[
            styles.topTitleImage,
            {height: 30, marginTop: kScreenHeight * 0.01},
          ]}
        />
        ...
        <ImageBackground
          ...
          <ImageBackground
            style={[
              styles.cardTitle,
              {width: 170, height: kScreenHeight * 0.05},
            ]}
            resizeMode="stretch"
