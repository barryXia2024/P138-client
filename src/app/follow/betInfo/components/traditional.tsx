...
export const Traditional = ({ orderInfo }: { orderInfo: CommonFollowHall.GetTrackingOrderItemResult }) => {
    ...
    return <View>
        <View className='mt-2 flex-row justify-between items-center'>
            ...
            <View className='gap-2'>
                ...
                <Text className='text-white border-[#91dcfd] border-2 bg-[#91dcfd] rounded-md p-1 text-[rgb(145, 220, 253)]'>{dayjs(orderInfo?.buyEndTime ?? undefined).format('MM-DD HH:mm')}</Text>
            </View>
        </View>
