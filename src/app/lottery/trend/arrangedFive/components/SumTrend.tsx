...
import { themeBlueColor } from '@/p138-react-common/utils/styles/color';
const CELL_WIDTH = CELL_WIDTH_BASE
const config = [
  {
    title: '和值',
    nums: [''],
    width: CELL_WIDTH *1.1,
  },
  {
    title: '和值分布',
    nums: Array.from({length: 46}, (_, index) => index.toString()),
    width: CELL_WIDTH *1.1,
  },
