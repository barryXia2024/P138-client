...
import {useSevenHappyStore} from '../../sevenHappy/store/useSevenHappyStore';
...
export default function BetlistPage() {
  ...
  const {lotteryData,quickPick,buildTicket} = useSevenHappyStore();
              ...
              router.push({
                ...
                params: {
                  jcBetsInfoString: JSON.stringify(
                    tickets.map(t => ({...t, game: 'SevenHappy'})),
                  ),
                  amout: totalAmount,
